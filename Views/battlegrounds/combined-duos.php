...
FROM (
    ...
    FROM (
        ...
        FROM (
            SELECT 'battlegrounds_season_7_ap_duos' AS source_table, accountid, rating
            FROM battlegrounds_season_7_ap_duos
            UNION ALL
            SELECT 'battlegrounds_season_7_eu_duos' AS source_table, accountid, rating
            FROM battlegrounds_season_7_eu_duos
            UNION ALL
            SELECT 'battlegrounds_season_7_us_duos' AS source_table, accountid, rating
