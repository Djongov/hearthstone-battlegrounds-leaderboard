...
class ThemeSwitcher
{
    ...
    {
        return '<button id="theme-toggle" title="Toggle Light/Dark" type="button" class="h-12 w-10 border border-gray-400 dark:border-gray-200 hover:bg-gray-100 dark:hover:bg-gray-700 focus:outline-none focus:ring-4 focus:ring-gray-200 dark:focus:ring-gray-700 rounded-lg text-sm p-2">
